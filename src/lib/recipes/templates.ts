...
export const RECIPE_TEMPLATES: RecipeTemplate[] = [
  ...
  // Twitter
  {
    slug: 'morning-twitter-digest',
    name: 'Morning Twitter Digest',
    description: 'Summarize overnight activity from your timeline',
    category: 'Productivity',
    requiredIntegrations: ['twitter'],
    triggerType: 'schedule',
    triggerConfig: { cron: '0 8 * * *', timezone: 'UTC' },
    instructions: "Get my Twitter timeline (last 20 tweets). Summarize the key themes, interesting takes, and any breaking news. Group by topic if there are clusters. Keep it brief and scannable — bullet points, not paragraphs.",
    previewOutput: "🐦 **Twitter Digest**\n\n📰 **Breaking:** SEC approved new crypto ETF rules\n- @Bloomberg, @CoinDesk, and 5 others discussing\n\n🤖 **AI/Tech:** Anthropic launched new agent SDK\n- @AnthropicAI thread got 2.4K likes\n- Several devs sharing early projects\n\n💬 **Your circles:** @friend posted about their new startup launch",
    icon: '🐦',
  },
  {
    slug: 'twitter-topic-monitor',
    name: 'Topic Monitor',
    description: 'Alert when a topic gets significant attention on Twitter',
    category: 'Productivity',
    requiredIntegrations: ['twitter'],
    triggerType: 'schedule',
    triggerConfig: { cron: '0 */4 * * *', timezone: 'UTC' },
    instructions: "Search Twitter for [TOPIC]. If there are more than 10 tweets in the last 4 hours with significant engagement (100+ likes or retweets), send me a summary of the most notable ones. If the topic is quiet, don't send anything.",
    previewOutput: "🔔 **Topic Alert: x402 protocol**\n\n12 tweets in the last 4 hours\n\n🔥 Top tweet by @coinbase (1.2K likes):\n\"x402 is now live on mainnet. Any API can accept crypto payments with 3 lines of code.\"\n\n📈 Sentiment: Very positive (90%)\n\n3 more notable tweets...",
    icon: '🔔',
  },
]
